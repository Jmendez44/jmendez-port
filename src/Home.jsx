      ...
      <div className="code-box">
        <TypedReact
          strings={[
            ...
            `<span class="about-fin">Hello! My name is Jenuel. I'm a <span class="highlight-r">Web Developer</span> based in NYC. I have always had a passion for <span class="highlight-l">creating things</span> &amp; <span class="highlight-y">solving problems</span>. Nowadays I use this creativity to design and develop cool stuff on the internet. </span>`
          ]}
        />
